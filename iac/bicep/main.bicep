...
resource customVision 'Microsoft.CognitiveServices/accounts@2021-06-01-preview' = {
  ...
  properties: {
    apiProperties: {
      predictionResourceId: '/subscriptions/${subscription().subscriptionId}/resourceGroups/${resourceGroup().name}/providers/Microsoft.CognitiveServices/accounts/customvision-${uniqueSuffix}'
    }
  }
}