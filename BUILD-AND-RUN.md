...
1. Clone the repo: `git clone https://github.com/{username}/github-copilot`
...
```bash
cd album-api && dapr run --app-id album-api --app-port 5000 --dapr-http-port 3500 --components-path ../dapr-components/local -- dotnet run
```
