...
This workshop's challenges are a fork from the original Hackaton [accessible here](https://github.com/microsoft/CopilotHackathon). We just wanted to integrate it into the [Github-Copilot](https://github.com/huangyingting/github-copilot) format and add some exercises. 
